...
public class OrdersTopicHandler(AppDbContext dbContext, ILogger<OrdersTopicHandler> logger)
{
        ...
        ServiceBusMessageActions messageActions)
    {
        ...
        try
        {
            var order = JsonSerializer.Deserialize<OrderMessageModel>(message.Body);
